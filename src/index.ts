...
mcpServer.tool(
  "mcp_illustrator_get_layers",
  "Get layers for a specific Illustrator file.",
  async ({ }) => {
...
mcpServer.tool(
  "mcp_illustrator_get_layer_svg",
  "Get the svg of a layer by name",
  {
    layerName: z
        .string()
...
async function callOAScript(scriptName: string, args: string[]) {
